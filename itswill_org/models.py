...
class RecapDataMixin(models.Model):
  ...
  count_characters = BigStatField(short_name = "characters", show_recap = False, show_leaderboard = False, verbose_name = "Total characters typed:", unit = "chatter", default = 0)
